...
// import { asyncloadTv, removeTv } from "./store/action/action";
      ...
      <div className="w-full flex gap-10 mt-5 flex-col md:flex-row">
        ...
        <div className="content text-white">
          ...
          <div className="flex items-center gap-5 mt-4 md:flex-row flex-col">
            ...
            <p className="text-md">{info.detail.first_air_date}</p>

            <h1 className="flex gap-4 font-normal text-md">
              {info.detail.type}
            </h1>

            <h1 className="font-normal text-md">{info.detail.seasons.length} Season</h1>
          </div>
